...
import com.aplicativocomercial.DataSourceBasedMultiTenantConnectionProviderImpl;
...
public class MultitenancyConfiguration {
    ...
    public DataSourceBasedMultiTenantConnectionProviderImpl dataSourceBasedMultiTenantConnectionProvider() {
        ...
        return new DataSourceBasedMultiTenantConnectionProviderImpl(multitenancyProperties.getBancoPadrao().getName(), dataSources);
    }
